        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                    ...
                    <div class="customer-card mb-3">
                        <div class="col-sm-2 col-md-2 col-lg-2 ">
                            <div class="div" style="padding-right: 0 !important;background: beige;margin: 0 5px 10px 0;padding:2px 0">
                                <div class="profile">
                                    @if ($cmo->image)
                                    <img src="{{asset($cmo->image)}}" alt="" style="width:100px;height:100px;border-radius:50%;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);display:block;margin:0 auto;" class="image-style mb-3">
                                    @else
                                ...
                                <h5 style="text-align:center;"><b>{{ $cmo->name }}</b></h5>
                            </div>
                        </div>
                ...
                center">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="{{route('team.investor')}}" class="btn btn-info text_btn" style="color: #fff !important">{{ $teamLeaderCount }}</a>
                                        </div>
                                    </div>
                                </div>
                ...
                center">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12" style="text-align:
                center">
                                    <div class="card">
                                        <div class="card-body">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3" style="text-align:
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('active.suspect.list') }}" class="btn btn-info text_btn"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3" style="text-align:
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('mpl.list') }}" class="btn btn-info text_btn"></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3 my-4" style="text-align:
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('sgl.list') }}" class="btn btn-info text_btn"></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xl-3 my-4" style="text-align:
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('junk.suspect.list') }}" class="btn btn-info text_btn"></a>
                    </div>
                </div>
            </div>
        </div>
