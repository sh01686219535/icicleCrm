                ...
                <div class="card-body" >
                    ...
                    @endphp
                        ...
                        <div class="area-h3 mpl" class="area-h3" style="display: flex; align-items: center; justify-content: space-between;">
                            <h2>Junk list</h2>
                            <a class="btn btn-primary" href="{{ route('junk.excel') }}">Excel</a>
                        </div>
                        ...
                        <table class="table table-hover table-borderd" id="example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if(Auth::guard('admin')->user()->can('view-junk-suspect-list'))
                                    <td>
                                        <a class="btn btn-info" href="{{ route('junk.edit', $value->id) }}"><i class="fas fa-edit"></i></a>
