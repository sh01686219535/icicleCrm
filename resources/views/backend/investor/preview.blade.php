                    ...
                    <div class="main-1">
                       ...
                       <div class="main" style="width:100%;">
                        ...
                        <div class="main" style="width:100%;page-break-after: always; ">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:43%;display:inline-block;">
                                <p style="width:29%;display:inline-block;"><b>Cheque Number</b>:</p>
                                <input type="text" value="" id="chq" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;margin-left:17px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                ...
                                <input type="text" value="" id="alternativePhone" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                        </div>
                            <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
...
<script>
    $(document).ready(function() {
        ...
        const nomimageData = localStorage.getItem('nomimageData');
        ...
        console.log(formData[31].name);
        
        document.getElementById('userImage').src = imageData;
        document.getElementById('nomuserImage').src = nomimageData;

        if(formData[32].name == 'quarterly'){
            $('#modeofpay').val("Quarterly");

        }
        else if(formData[32].name == 'installment'){
            $('#modeofpay').val("Monthly");

        }
        else if(formData[32].name == 'yearly'){
            $('#modeofpay').val("Yearly");

        }
        else if(formData[32].name == 'half_yearly'){
            $('#modeofpay').val("Half Yearly");

        }
        else if(formData[32].name == 'at_a_time'){
