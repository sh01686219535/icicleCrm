                ...
                <div>
                    <div class="main-1">
                       <!-- <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                        ...
                        {{-- <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="display:inline-block;"><b>File No</b> :</p>
                            <input type="text" value="{{ $investor->fileName }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div> --}}
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                        ...
                        <div class="main" style="width:100%;">
                            ...
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->passport }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:44%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:35%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->ownership_size }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:41%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:51%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->category_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:46%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                            ...
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:42%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->installment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:49%;" class="form-control" readonly>
                                @elseif($investor->quarterly)
                                <input type="text" value="{{ $investor->quarterly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:49%;" class="form-control" readonly>
                                @elseif($investor->half_yearly)
                                <input type="text" value="{{ $investor->half_yearly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:49%;" class="form-control" readonly>
                                @elseif($investor->yearly)
                                <input type="text" value="{{ $investor->yearly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:49%;" class="form-control" readonly>
                                @elseif($investor->at_a_time)
                                <input type="text" value="{{ $investor->at_a_time }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:49%;" class="form-control" readonly>
                                @endif
                        ...
                        <div class="main" style="width:100%;">
                            ...
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->price_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:43%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:51%;display:inline-block;">
                        ...
                        <div class="main" style="width:100%;">
                            ...
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->special_discount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:24%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                        ...
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Cheque Number</b>:</p>
                                <input type="text" value="{{ $investor->chq }}" style="margin-left:15px;padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="display:inline-block;"><b>Alternative Phone</b>:</p>
                                <input type="text" value="{{ $investor->alternativePhone }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        ...
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:44%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->allow_amount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:31%;" class="form-control" readonly>
                            </div>
