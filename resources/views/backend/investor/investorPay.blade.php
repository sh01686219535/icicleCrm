                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body" >
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="number_installment_upcomming">Installment Number</label>
                                                        <input type="text" name="number_installment_upcomming" id="number_installment_upcomming" class="form-control">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="extra_pay">Remarks</label>
                                                        <input type="text" name="extra_pay" id="extra_pay" class="form-control">
                                                    </div>
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row my-3">
                                                    ...
                                                    <!-- quarterly -->
                                                    <input type="hidden" id="quarterly">
                                                    <!-- half yearly -->
                                                    <input type="hidden" id="half_yearly">
                                                    <!-- yearly -->
                                                    <input type="hidden" id="yearly">
                                                    <!-- end sharif -->
