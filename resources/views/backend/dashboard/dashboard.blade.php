            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body" style="background: #d65b09">
                            <a href="{{route('investorList')}}">
                                <span>Total Client in <strong>{{ $currentMonthName }}</strong></span>
                                <h3 class="card-title text-nowrap mb-1">{{ $currentInvestor }} Person</h3>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-6 ml-5">
                    <div class="card">
                        <div class="card-body" style="background: #454645">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ round($bookingMoneyMonthly) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-6 ml-5">
                    <div class="card">
                        <div class="card-body" style="background: #454645">
                            <span>Installment Received in </strong>{{ $currentMonthName }}</span>
                            <h3 class="card-title text-nowrap mb-1">{{ round($monthlyPaid) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-6 ml-5">
                    <div class="card">
                        <div class="card-body" style="background: #15d5d5">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ round($bookingMoney) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body" style="background: #018012">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ round($totalAmount) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body" style="background: #008c91">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ round($totalIncome) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body" style="background: #ce2b02">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ round($total_unpaid) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body" style="background: #013cb9">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ round($investors) }} Tk.</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-6 mb-4">
                    ...
                    <div class="card">
                        <div class="card-body" style="background: #b90172">
                            <a href="{{route('unpaidInvestor')}}">
                                ...
                                <h3 class="card-title text-nowrap mb-1">{{ round($monthlyUnpaid) }} Tk.</h3>
                            </a>
                        </div>
                    </div>
                </div>
