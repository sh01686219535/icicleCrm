    ...
    <div style="width: 900px;
        ...
        <div style="height: 130px;">
            ...
            <div style="float:right;margin-right:140px;margin-top:20px;">
                ...
                @if($booking->investor->user_image)
                <img height="120px" width="120" src="{{ asset($booking->investor->user_image) }}" alt="" />
                @else
                <img style="width:120px;height:120px" id="showNImage" src="{{ asset('backend/img/previewImage.png') }}" alt="" class="image-style mb-3">
                @endif

                @if($booking->investor->nominee_image)
                <img height="120px" width="120" src="{{ asset($booking->investor->nominee_image) }}" alt="" />
                @else
                <img style="width:120px;height:120px" id="showNImage" src="{{ asset('backend/img/previewImage.png') }}" alt="" class="image-style mb-3">
                @endif
            </div>
        ...
        <div>
            <div style="width: 850px;
                ...
                <div>
                    <div class="main-1">
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            <input type="text" value="{{ $booking->investor->serial_number }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="display:inline-block;"><b>Applicant's Name</b> :</p>
                            <input type="text" value="{{ $booking->investor->name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Father Name</b> :</p>
                            <input type="text" value="{{ $booking->investor->fathers_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Mother Name</b>:</p>
                            <input type="text" value="{{ $booking->investor->mothers_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-top:18px;margin-bottom: -7px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->phone }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-top:18px;margin-bottom: -7px;margin-left:50px;width:50%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->email }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:47%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-top:10px;margin-bottom: -10px;width:49%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->facebook }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;margin-left:-30px;width:49%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->religion }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:43%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:49%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->spouse_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;margin-left:-30px;">
                                ...
                                <input type="text" value="{{ $booking->investor->spouse_date_birth }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:30%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:49%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Birth Date</b>:</p>
                                <input type="text" value="{{ $booking->investor->birth_date }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;margin-left:-30px;">
                                <p style="display:inline-block;"><b>Marriage Date</b>:</p>
                                <input type="text" value="{{ $booking->investor->marriage }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:38%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:49%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Profession</b>:</p>
                                <input type="text" value="{{ $booking->investor->profession }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;margin-left:-30px;">
                                <p style="display:inline-block;"><b>NID Number</b>:</p>
                                <input type="text" value="{{ $booking->investor->nid_passport }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->nationality }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->passport }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:44%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:35%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->ownership_size }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:41%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:51%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->category_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:46%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="width:35.5%;display:inline-block;"><b>No Ownership</b>:</p>
                                <input type="text" value="{{ $booking->investor->no_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:42%;display:inline-block;">
                                ...
                                @if($booking->investor->installment)
                                <input type="text" value="{{ $booking->investor->installment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($booking->investor->quarterly)
                                <input type="text" value="{{ $booking->investor->quarterly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($booking->investor->half_yearly)
                                <input type="text" value="{{ $booking->investor->half_yearly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($booking->investor->yearly)
                                <input type="text" value="{{ $booking->investor->yearly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($booking->investor->at_a_time)
                                <input type="text" value="{{ $booking->investor->at_a_time }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @endif
                        ...
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->price_ownership_word }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="width:45%;display:inline-block;"><b>Price per Ownership</b>:</p>
                                <input type="text" value="{{ $booking->investor->price_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:43%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:51%;display:inline-block;">
                                <p style="width:30%;display:inline-block;"><b>TotalPrice(Word)</b>:</p>
                                <input type="text" value="{{ $booking->investor->agreed_price_word }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="display:inline-block;"><b>Total Price</b>:</p>
                                <input type="text" value="{{ $booking->investor->agreed_price }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:38%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:52%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->special_discount_word }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="display:inline-block;"><b>Special Discount</b>:</p>
                                <input type="text" value="{{ $booking->investor->special_discount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:24%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29%;display:inline-block;"><b>Down Payment</b>:</p>
                                <input type="text" value="{{ $booking->investor->down_payment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:15.5px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;margin-left:30px;">
                                ...
                                <input type="text" value="{{ $booking->investor->down_payment_date }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:31%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:56%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->down_payment_inWord }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;margin-left:-50px;">
                                ...
                                <input type="text" value="{{ $booking->investor->payment_type2 }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;page-break-after: always; ">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29%;display:inline-block;"><b>Payment Date</b>:</p>
                                <input type="text" value="{{ $booking->investor->payment_type_date2 }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;margin-left:17px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->no_of_installment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:33.5%;display:inline-block;"><b>Inst. month</b>:</p>
                                <input type="text" value="{{ $booking->investor->inst_per_month }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Main Amount</b>:</p>
                                <input type="text" value="{{ $booking->investor->main_amount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:32%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:44%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $booking->investor->allow_amount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:31%;" class="form-control" readonly>
                            </div>

                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:35%;display:inline-block;">
                                <p style="display:inline-block;"><b>Project Name</b>:</p>
                                <input type="text" value="{{ $booking->investor->project_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:32.5%;display:inline-block;"><b>Start From</b>:</p>
                                <input type="text" value="{{ $booking->investor->start_from }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>End date</b>:</p>
                                <input type="text" value="{{ $booking->investor->start_to }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:32.5%;display:inline-block;"><b>Nomineec Name</b>:</p>
                                <input type="text" value="{{ $booking->investor->nominee_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Number</b>:</p>
                                <input type="text" value="{{ $booking->investor->nominee_cell_no }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:42%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Relation To Nominee</b>:</p>
                                <input type="text" value="{{ $booking->investor->relation_to_nominee }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:42%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (A)</b>:</p>
                                <input type="text" value="{{ $booking->investor->reference_name_a }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (A) Number</b>:</p>
                                <input type="text" value="{{ $booking->investor->reference_cell_a }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (B)</b>:</p>
                                <input type="text" value="{{ $booking->investor->reference_name_b }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (B) Number</b>:</p>
                                <input type="text" value="{{ $booking->investor->reference_cell_b }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Assist By</b>:</p>
                                @foreach(explode(',',$booking->investor->team_leader) as $value)
                                @php
                        ...
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            @php
                            $assists = [];
                            foreach (explode(',',$booking->investor->employee_id) as $value){
                        ...
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            <input type="text" value="{{ $booking->investor->present_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>

                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:18%;display:inline-block;"><b>Permanent Address</b>:</p>
                            <input type="text" value="{{ $booking->investor->permanent_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:59%;margin-left:-18px;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Office Address</b>:</p>
                            <input type="text" value="{{ $booking->investor->office_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Project Address</b>:</p>
                            <input type="text" value="{{ $booking->investor->project_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                    </div>
                </div>
                ...
                return $quarterly_dates;
                           ...
                           $instNumber = $booking->investor->no_of_installment;
                           $inst_per_month = $booking->investor->inst_per_month;

                            $start_from = new DateTime($booking->investor->start_from);
                            $start_to = new DateTime($booking->investor->start_to);
                            ...
                            foreach ($quarterly_dates as $index => $quarter)
                             ...
                             {
                                $bdt_inst_amount = $inst_per_month; // Calculate installment amount in BDT
...
echo "</tr>";
            ...
            $inst_amount = $booking->investor->inst_per_month ;
...
@endif
{{-- <td>
@foreach ($booking->investor as  $item)
