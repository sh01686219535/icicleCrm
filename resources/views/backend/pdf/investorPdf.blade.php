     ...
     <div style="width: 900px;
        ...
        <div style="height: 130px;">
            ...
            <div style="float:right;margin-right:140px;margin-top:20px;">
                ...
                <img height="120px" width="120" src="{{ asset($investor->nominee_image) }}" alt="" />
                @else
                <img style="width:120px;height:120px" id="showNImage" src="{{ asset('backend/img/previewImage.png') }}" alt="" class="image-style mb-3">
                @endif
            </div> 
...
<div>
                    <div class="main-1">
                       <!-- <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            <input type="text" value="{{ $investor->serial_number }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                        </div> -->
                        <div class="main" style="width:100%;">
                            ...
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;margin-left:-43px;width:46%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->fileNumber }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                        ...
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            <input type="text" value="{{ $investor->fathers_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Mother Name</b>:</p>
                            <input type="text" value="{{ $investor->mothers_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-top:18px;margin-bottom: -7px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->phone }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-top:18px;margin-bottom: -7px;margin-left:50px;width:50%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->email }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:47%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-top:10px;margin-bottom: -10px;width:49%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Facebook Id</b>:</p>
                                <input type="text" value="{{ $investor->facebook }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;margin-left:-30px;width:49%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->religion }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:43%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:49%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->spouse_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;margin-left:-30px;">
                                ...
                                <input type="text" value="{{ $investor->spouse_date_birth }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:30%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:49%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Birth Date</b>:</p>
                                <input type="text" value="{{ $investor->birth_date }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;margin-left:-30px;">
                                <p style="display:inline-block;"><b>Marriage Date</b>:</p>
                                <input type="text" value="{{ $investor->marriage }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:38%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:49%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Profession</b>:</p>
                                <input type="text" value="{{ $investor->profession }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;margin-left:-30px;">
                                <p style="display:inline-block;"><b>NID Number</b>:</p>
                                <input type="text" value="{{ $investor->nid_passport }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->nationality }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->passport }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:42%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:35%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->ownership_size }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:51%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->category_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:44%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="width:35.5%;display:inline-block;"><b>No Ownership</b>:</p>
                                <input type="text" value="{{ $investor->no_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:38%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->installment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($investor->quarterly)
                                <input type="text" value="{{ $investor->quarterly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($investor->half_yearly)
                                <input type="text" value="{{ $investor->half_yearly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($investor->yearly)
                                <input type="text" value="{{ $investor->yearly }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @elseif($investor->at_a_time)
                                <input type="text" value="{{ $investor->at_a_time }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:62%;" class="form-control" readonly>
                                @endif
                            </div>
                        ...
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->price_ownership_word }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="width:45%;display:inline-block;"><b>Price per Ownership</b>:</p>
                                <input type="text" value="{{ $investor->price_ownership }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:39%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:51%;display:inline-block;">
                                <p style="width:28%;display:inline-block;"><b>TotalPrice(Word)</b>:</p>
                                <input type="text" value="{{ $investor->agreed_price_word }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="display:inline-block;"><b>Total Price</b>:</p>
                                <input type="text" value="{{ $investor->agreed_price }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:38%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:56%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->special_discount_word }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;">
                                <p style="display:inline-block;"><b>Special Discount</b>:</p>
                                <input type="text" value="{{ $investor->special_discount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:16%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29%;display:inline-block;"><b>Booking Money</b>:</p>
                                <input type="text" value="{{ $investor->down_payment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:15.5px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;margin-left:30px;">
                                ...
                                <input type="text" value="{{ $investor->down_payment_date }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:31%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:56%;display:inline-block;">
                                <p style="width:29%;display:inline-block;"><b>B.Money(Word)</b>:</p>
                                <input type="text" value="{{ $investor->down_payment_inWord }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:-7px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:40%;display:inline-block;margin-left:-50px;">
                                ...
                                <input type="text" value="{{ $investor->payment_type2 }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29%;display:inline-block;"><b>Cheque Number</b>:</p>
                                <input type="text" value="{{ $investor->chq }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:15.5px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;margin-left:0px;">
                                <p style="display:inline-block;"><b>Alternative Phone</b>:</p>
                                <input type="text" value="{{ $investor->alternativePhone }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:31%;" class="form-control" readonly>
                            </div>
                        </div>
                        @if($investor->payment_type2 = 'Online_Payment')
                            <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:30px;width:46%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->branch_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:56%;margin-left:15.5px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:30px;width:50%;display:inline-block;margin-left:30px;">
                                ...
                                <input type="text" value="{{ $investor->bank_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:31%;" class="form-control" readonly>
                            </div>
                        </div>
                        @endif
                        <div class="main" style="width:100%; ">
                            <div class="left" style="margin-bottom: -10px;margin-top:20px;width:46%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->payment_type_date2 }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;margin-left:17px;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->no_of_installment }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:36%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Inst. month</b>:</p>
                                <input type="text" value="{{ $investor->inst_per_month }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Main Amount</b>:</p>
                                <input type="text" value="{{ $investor->main_amount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:32%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="margin-top:10px;width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:25%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->allow_amount }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:27%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:70%;display:inline-block;">
                                ...
                                <input type="text" value="{{ $investor->project_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:53%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;margin-top:10px;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Start From</b>:</p>
                                <input type="text" value="{{ $investor->start_from }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>End date</b>:</p>
                                <input type="text" value="{{ $investor->start_to }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="width:29.5%;display:inline-block;"><b>Nomineec Name</b>:</p>
                                <input type="text" value="{{ $investor->nominee_name }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Number</b>:</p>
                                <input type="text" value="{{ $investor->nominee_cell_no }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:42%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Relation To Nominee</b>:</p>
                                <input type="text" value="{{ $investor->relation_to_nominee }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:42%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (A)</b>:</p>
                                <input type="text" value="{{ $investor->reference_name_a }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (A) Number</b>:</p>
                                <input type="text" value="{{ $investor->reference_cell_a }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (B)</b>:</p>
                                <input type="text" value="{{ $investor->reference_name_b }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:40%;" class="form-control" readonly>
                            </div>
                        </div>
                        <div class="main" style="width:100%;">
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:46%;display:inline-block;">
                                <p style="display:inline-block;"><b>Name (B) Number</b>:</p>
                                <input type="text" value="{{ $investor->reference_cell_b }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:48%;" class="form-control" readonly>
                            </div>
                            <div class="left" style="margin-bottom: -10px;margin-top:10px;width:50%;display:inline-block;">
                                <p style="display:inline-block;"><b>Assist By</b>:</p>
                                @foreach(explode(',',$investor->team_leader) as $value)
                                @php
                        ...
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            <input type="text" value="{{ $investor->others_instruction }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Sales Person</b>:</p>
                            @php
                            $assists = [];
                            foreach (explode(',',$investor->employee_id) as $value){
                        ...
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            ...
                            <input type="text" value="{{ $investor->present_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>

                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:18%;display:inline-block;"><b>Permanent Address</b>:</p>
                            <input type="text" value="{{ $investor->permanent_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:59%;margin-left:-18px;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Office Address</b>:</p>
                            <input type="text" value="{{ $investor->office_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                        <div class="left" style="margin-bottom: -10px;margin-top:10px;">
                            <p style="width:14.5%;display:inline-block;"><b>Project Address</b>:</p>
                            <input type="text" value="{{ $investor->project_address }}" style="padding: 8px;border: 2px solid darkgray;border-radius: 8px;background: #d1cece;width:60%;" class="form-control" readonly>
                        </div>
                    </div>
                </div>
...
<br><br><br><br><br><br><br><br><br><br>
                    ...
                    <table class="table" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{  $investor->down_payment_date }}</td>
                                <td>{{  $investor->down_payment }} BDT</td>
                            </tr>
                            @elseif($investorPay)
                            <tr>
                                <td style="width: 120px;">Down Payment</td>
                                <td>{{  $investorPay->created_at }}</td>
                                <td>{{  $investorPay->booking_money }} BDT</td>
                            </tr>
                            @endif
                        </tbody>
                        <tbody>
                            @if( $investor->quarterly)
                            @php
                ...
                return $quarterly_dates;
                           ...
                           $instNumber = $investor->no_of_installment;
                           $inst_per_month = $investor->inst_per_month;

                            $start_from = new DateTime($investor->start_from);
                            $start_to = new DateTime($investor->start_to);
...
echo "</tr>";
            ...
            $inst_amount = $investor->inst_per_month ;
