    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('store.assign.target.team')}}" method="post">
                        @csrf
                        <div class="row">
                        ...
                        <table class="table table-hover table-bordered" id="example">
                            ...
                            @php $i = 1 @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('target.team.edit',$value->id)}}" title="Edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <a href="{{route('target.team.delete',$value->id)}}" title="Delete" class="btn btn-danger" id="delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <form action="{{route('store.assign.target.team')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <label for="teamLead"></label>
                                <input type="text" value="{{$salesMan}}" id="targetAmount" class="form-control my-2" readonly>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="targetDate" id="date" class="form-control my-2" required>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                                <button type="submit" class="btn btn-info">Submit</button>
...
<script>
    $(document).ready(function() {
        $('#amount').keyup(function() {
            ...
            if (!isNaN(targetAmount) && !isNaN(amount) && amount > targetAmount) {
                alert("Entered amount is greater than the target amount.");
                // Set input value to zero
                $(this).val('0');
            }
        });
    });
