...
class PermissionAssignController extends Controller
{
    ...
    {
        $data = array();
        $data['active_menu'] = 'accessControl';
        $data['page_title'] = 'Access Control';
        ...
        return view('backend.permissionAssign.permissionAssign', compact('permissionAssign', 'rol', 'assign', 'role', 'data'));
        // }
    ...
    public function addAssignPermission()
    {
        ...
        return view('backend.permissionAssign.add-permissionAssign', compact('permission', 'rol', 'permissionAssign', 'module','data'));
        // }
        // abort(403, 'Unauthorized action.');
    }
    ...
    public function showEditAssignPermission($id)
    {
        ...
        return view('backend.permissionAssign.editPermissionAssign', compact('id', 'module', 'permissionAssign', 'permarray', 'role', 'roleToEdit','data'));
    }
