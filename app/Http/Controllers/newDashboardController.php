    ...
    public function dashboard()
    {
        ...
        if ($cmo || $gm) {
            if ($gm) {
                ...
                return view('backend.AuthUser.mainCmo', compact('lead','teamLeaderCount', 'employee', 'cmo', 'data', 'targetMoney', 'employeeTarget', 'unpaidAmount', 'currentMonthName'));
            }
        }
        //salesMan
        if ($salesMan) {
